	...
	$(document).ready( function() {	
		...
		$( 'input[class="cntctfrmmlt-delete"]' ).click( function() {
			if ( confirm( cntctfrmmlt_script_vars.cntctfrmmlt_delete_message ) ) {
				document.location.href = cntctfrmmlt_script_vars.cntctfrmmlt_location + "&del=" + $( this ).attr( 'name' ) + "&id=" + $( this ).parent( 'li' ).attr( 'id' );	
			}
		});
		...
		$( '.cntctfrmmlt-noactive' ).click( function() {
			if ( ! $( this ).parent( 'li' ).hasClass( 'cntctfrmmlt-activee' ) )
				document.location.href = cntctfrmmlt_script_vars.cntctfrmmlt_location + "&id=" + $( this ).parent( 'li' ).attr( 'id' ) + cntctfrmmlt_script_vars.cntctfrmmlt_action_slug;
		});

		/* Add style for active <li> */
